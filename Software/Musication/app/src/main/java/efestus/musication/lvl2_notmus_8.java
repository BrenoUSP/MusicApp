...
public class lvl2_notmus_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl2_notmus_8);
        ...
        but4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(points >= 8){
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(lvl2_notmus_8.this);
                    ...
                    builder1.setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    dialog.cancel();
                                    Intent intent = new Intent(lvl2_notmus_8.this, lvl3_content.class);
